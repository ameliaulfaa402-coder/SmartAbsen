...
public class DashboardForm extends javax.swing.JFrame {
    ...
    private void buttonDataKelasActionPerformed(java.awt.event.ActionEvent evt){
        try {
            new KelasForm().setVisible(true); // Buka Form Kelas
            this.dispose(); // Tutup Dashboard
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Form Kelas belum dibuat atau ada kesalahan!");
        }
    }
    
    private void buttonDataSiswaActionPerformed(java.awt.event.ActionEvent evt) {                                                
        try {
            new SiswaForm().setVisible(true); // Buka Form Siswa
            this.dispose();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Form Siswa belum dibuat atau ada kesalahan!");
        }
    }
    
    private void buttonDataAbsensiActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try {
            new AbsensiForm().setVisible(true); // Buka Form Absensi (yang sudah kamu buat sebelumnya)
            this.dispose();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Form Absensi belum dibuat atau ada kesalahan!");
        }
    }                                                 
    
    private void buttonLogoutActionPerformed(java.awt.event.ActionEvent evt) {                                             
        int konfirmasi = JOptionPane.showConfirmDialog(this, "Yakin ingin keluar dari aplikasi?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
        if (konfirmasi == JOptionPane.YES_OPTION) {
            // Bisa tambah kode untuk kembali ke LoginForm di sini
